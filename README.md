...
- **Frosty**
   ...
   - [Official Website](https://frostyapp.io/) | [Repo](https://github.com/tommyxchow/frosty)
   - [x] Open Source
...
- **Twire**
   ...
   - Official Website (N/A) | [Repo](https://github.com/twireapp/Twire)
   - [x] Open Source
   - [x] [Download for free](https://github.com/twireapp/Twire#-twire)
   - [x] Android

- **Xtra**

   - Xtra for Twitch is a Twitch client focused on providing the best viewing and chatting experience on mobile devices.
   - Official Website (N/A) | [Repo](https://github.com/crackededed/Xtra)
   - [x] Open Source
   - [x] [Download for free](https://github.com/crackededed/Xtra#download)
   - [x] Android
...
- **Kiwix**
   ...
   - [Official Website](https://kiwix.org/en/applications/) | [Android Repo](https://github.com/kiwix/kiwix-android) [iOS Repo](https://github.com/kiwix/kiwix-apple)
   - [x] Open Source
